...
IMAGE_DIR = 'C:/Users/allan/Fiap_OpenCV/yalefaces'
...
class EigenFace(object):
    ...
    def get_vector_representation(self):
        for ii, (_, image) in enumerate(self.image_dictionary.items()):
            if ii == 0:
                vector_2d = self.image_dictionary[list(self.image_dictionary.keys())[0]].flatten()
            else:
    ...
    def plot_image_dictionary(self):
        ...
        for ii, (name, v) in enumerate(dictionary.items()):
    ...
    def get_image_shape(self):
        return self.image_dictionary[list(self.image_dictionary.keys())[0]].shape
